...
You can configure your Karrio email server at http://localhost:4003/admin/constance/config/
...
```
http://app.karrio.invente.co.uk/email/YWxleC5taWxsZXIyNEBvdXRsb29rLmNvbQ-axd6yl-ce379fa50ced5079908ab669cabb456a89f441c2
```
...
mutation {
    request_password_reset(
        input: {
            ...
            redirect_url: "app.karrio.invente.co.uk/password/reset"
        }
    ) {
        errors {
            field
...
```
http://app.karrio.invente.co.uk/password/reset?uidb64=Mw&token=ax10pr-af2cc4352f19713547b12ab0dd6c0661
```
