...
...
- KARRIO_PUBLIC_URL=http://localhost:4003
+ KARRIO_PUBLIC_URL=http://[YOUR-VM-IP-ADDRESS]:4003
...
...
...
- DASHBOARD_URL=http://app.karrio.invente.co.uk
+ DASHBOARD_URL=http://[YOUR-VM-IP-ADDRESS]:4004
...
...
karrio.api        | [2023-04-24 07:59:42 +0000] [37] [INFO] Listening at: http://0.0.0.0:4003 (37)
...
karrio.api          karrio.docker.scarf.sh/karrio/server:2023.4.2     0.0.0.0:4003->4003/tcp, :::4003->4003/tcp
karrio.dashboard    karrio.docker.scarf.sh/karrio/dashboard:2023.4.2  0.0.0.0:4004->4004/tcp, :::4004->4004/tcp
...
-   The server should be be accessible at https://karrio.invente.co.uk
-   And the dashboard accessible at https://app.karrio.invente.co.uk
